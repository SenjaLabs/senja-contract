...
/**
 * @title sWBTC
 * @notice Synthetic Wrapped BTC token representing WBTC deposits in the Senja protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 8 decimals to match Bitcoin
 */
contract sWBTC is ERC20, Ownable {
    ...
    /**
     * @notice Constructs the sWBTC token contract
     * @dev Initializes with name "Wrapped BTC representative" and symbol "sWBTC"
     */
    constructor() ERC20("Wrapped BTC representative", "sWBTC") Ownable(msg.sender) {}
