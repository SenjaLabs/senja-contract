...
/**
 * @title sWETH
 * @notice Synthetic Wrapped ETH token representing WETH deposits in the Senja protocol
...
contract sWETH is ERC20, Ownable {
    ...
    /**
     * @notice Constructs the sWETH token contract
     * @dev Initializes with name "Wrapped ETH representative" and symbol "sWETH"
     */
    constructor() ERC20("Wrapped ETH representative", "sWETH") Ownable(msg.sender) {}
